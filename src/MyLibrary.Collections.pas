...
///   See <see xref="mylibrary.docs/collections" /> for an overview and usage
///   guidance.
/// </remarks>
...
type
  ...
  ///   <see cref="TPair&lt;TKey,TValue&gt;" /> values. Inherited
  ///   <c>Contains</c> and <c>Remove</c> operations require both the key and
  ///   value to match. Keys use the dictionary's key comparer; values use the
  ///   default equality comparer for <typeparamref name="TValue" />. Inherited
  ///   <c>Add</c> raises <see cref="EArgumentException" /> when the pair's key
  ///   already exists.
  /// </remarks>
  /// <seealso cref="TCollections" />
  ...
  public
    ...
    ///   True to free objects when they are removed, deleted, cleared, or when
    ...
    ///   the lifetime of the objects it contains. Assigning a new value through
    ///   <see cref="IList&lt;T&gt;.Items" /> does not free the object being replaced.
    /// </remarks>
    /// <example>
    /// <code lang="delphi">
    ///   var
