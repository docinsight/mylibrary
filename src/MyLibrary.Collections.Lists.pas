...
type
  ...
  ///   Assigning a new value through the inherited <c>Items</c> property does not
  ...
  public
    ...
    ///   True to free contained objects when they are removed, deleted, cleared,
    ///   or when the list is destroyed; otherwise, false.
    /// </param>
    /// <remarks>
    ...
    ///   inherited <c>Remove</c>, and the destructor. Replacing an object through
    ///   the inherited <c>Items</c> property does not free the previous value.
    /// </remarks>
